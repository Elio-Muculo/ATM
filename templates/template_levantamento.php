...
<table width="100%"  style="text-align: center; padding: 30px 0;">
    <thead>
        <tr>
            <th scope="col">Valor Levantado</th>
            <th scope="col">Saldo Contabilístico</th>
        </tr>
    </thead>
    <tbody>
        <tr  style="background-color: #bababa;">
            <td ><?= $_SESSION['levantado']  . " MZN"; ?></td>
            <td style="padding: 4px 0; margin: 3px 0;"><?= $_SESSION['saldo']  . " MZN"; ?></td>
        </tr>
    </tbody>
</table>
